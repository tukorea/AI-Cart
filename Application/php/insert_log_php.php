<?php
    ...
    if (($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['submit']))
    {
        ...
        {
            try{ //try , catch
                $stmt = $con->prepare('INSERT INTO users(useremail, userid, userpw, username, userquestion, useranswer, usercreated)
                 VALUES(:useremail,:userid, :userpw, :username,  :userquestion, :useranswer, :usercreated )');
